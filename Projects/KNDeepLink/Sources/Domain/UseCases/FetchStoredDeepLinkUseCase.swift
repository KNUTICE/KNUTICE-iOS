...
public protocol FetchStoredDeepLinkUseCase: Actor {
...
public actor FetchStoredDeepLinkUseCaseImpl: FetchStoredDeepLinkUseCase {
    public func execute() async throws -> DeepLink {
