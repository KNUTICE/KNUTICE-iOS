...
extension MainTableViewController {
    ...
    func createSectionHeader(for section: Int) -> UIView {
        let headerColors: [UIColor] = [
            KNUTICEAsset.accentOrange.color,
            KNUTICEAsset.accentAmber.color,
            KNUTICEAsset.accentMint.color,
            KNUTICEAsset.accentBlue.color,
            KNUTICEAsset.accentPurple.color
        ]
        ...
        let button: UIButton = {
            ...
            button.tintColor = KNUTICEAsset.grayButton.color
