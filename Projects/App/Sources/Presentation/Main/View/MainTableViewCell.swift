...
class MainTableViewCell: UITableViewCell {
    ...
    let titleLabel: UILabel = {
        ...
        label.textColor = KNUTICEAsset.accentColor.color
    ...
    let subTitleLabel: UILabel = {
        ...
        label.textColor = KNUTICEAsset.subTitle.color
        
        return label
    }()
    let cellBackgroundView: UIView = {
        let backgroundView = UIView()
        backgroundView.backgroundColor = KNUTICEAsset.mainCellBackground.color
        if #available(iOS 26, *) {
    ...
    override func setHighlighted(_ highlighted: Bool, animated: Bool) {
        cellBackgroundView.backgroundColor = highlighted ? KNUTICEAsset.cellHighlight.color : KNUTICEAsset.mainCellBackground.color
    }
