...
final class NoticeContentViewController: UIViewController {
    ...
    private lazy var bookmarkButton: UIButton = {
        ...
        if #available(iOS 26.0, *) {
            button.tintColor = KNUTICEAsset.accent2.color
            button.configuration = .prominentGlass()
        } else {
            button.tintColor = .white
            button.backgroundColor = KNUTICEAsset.accent2.color
        }
    ...
    override func viewDidLoad() {
        ...
        setupNavigationBar()
        bind()
        view.backgroundColor = KNUTICEAsset.detailViewBackground.color
