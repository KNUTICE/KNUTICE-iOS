...
final class SearchViewController: UIViewController, CompositionalLayoutConfigurable {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collectionView.backgroundColor = KNUTICEAsset.primaryBackground.color
    ...
    lazy var bookmarkTableView: UITableView = {
        ...
        tableView.backgroundColor = KNUTICEAsset.primaryBackground.color
    ...
    @Injected(\.searchViewModel) var viewModel
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = KNUTICEAsset.primaryBackground.color
        setupLayout()
        bind()
    }
