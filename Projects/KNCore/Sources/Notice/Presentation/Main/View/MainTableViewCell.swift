...
class MainTableViewCell: UITableViewCell {
    ...
    let cellBackgroundView: UIView = {
        ...
        backgroundView.backgroundColor = KNDesignSystemAsset.mainCellBackground.color
        if #available(iOS 26, *) {
    ...
    override func setHighlighted(_ highlighted: Bool, animated: Bool) {
        cellBackgroundView.backgroundColor = highlighted ? KNDesignSystemAsset.cellHighlight.color : KNDesignSystemAsset.mainCellBackground.color
    }
