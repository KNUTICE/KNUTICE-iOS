...
extension MainTableViewController {
    ...
    func createSectionHeader(for section: Int) -> UIView {
        let headerColors: [UIColor] = [
            KNDesignSystemAsset.accentOrange.color,
            KNDesignSystemAsset.accentAmber.color,
            KNDesignSystemAsset.accentMint.color,
            KNDesignSystemAsset.accentBlue.color,
            KNDesignSystemAsset.accentPurple.color
        ]
        ...
        let button: UIButton = {
            ...
            button.tintColor = KNDesignSystemAsset.grayButton.color
