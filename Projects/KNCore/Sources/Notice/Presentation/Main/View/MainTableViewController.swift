...
public final class MainTableViewController: UIViewController, FirstTabNavigationItemConfigurable, SettingButtonConfigurable {
    ...
    @Injected(\.mainTableViewModel) var viewModel: MainTableViewModel
